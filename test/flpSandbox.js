		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "sap.ui.core.EventBus",
									"targetURL": "#josecarloshtml5module-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"josecarloshtml5module-display": {
								"semanticObject": "josecarloshtml5module",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=josecarlos.html5module",
									"url": sap.ui.require.toUrl("josecarlos/html5module")
								}
							}
						}
					}
